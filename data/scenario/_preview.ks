...
[mask time=10]
[bg  time="10"  method="crossfade"  storage="ominousforest.png"  ]
[playbgm  volume="100"  time="1000"  loop="true"  storage="Whispers-of-the-Elder-Wood.ogg"  ]
[tb_show_message_window] 
[chara_show  name="Medeyna"  time="10"  wait="true"  storage="chara/1/MediNormal.png"  width="409"  height="543"  left="50"  top="80"  reflect="false"  ]
[mask_off time=10]
...
[chara_mod  name="Seyra"  time="710"  cross="true"  storage="chara/3/Сейра.png"  ]
[chara_mod  name="Medeyna"  time="600"  cross="true"  storage="chara/1/МедейнаSurprise.png"  ]
[tb_start_text mode=1 ]
...
[chara_mod  name="Seyra"  time="600"  cross="true"  storage="chara/3/СейраSurprised.png"  ]
[tb_start_text mode=1 ]
#Девушка
{bold}Ме... Меди? {/bold}[p]
#Медейна
...
[chara_mod  name="Seyra"  time="600"  cross="true"  storage="chara/3/Сейра.png"  ]
[tb_start_text mode=1 ]
#Сейра
...
[chara_mod  name="Medeyna"  time="600"  cross="true"  storage="chara/1/МедейнаWorried.png"  ]
[tb_start_tyrano_code]
...
[cm  ]
[chara_mod  name="Medeyna"  time="600"  cross="true"  storage="chara/1/МедейнаУлыбка.png"  ]
...
[chara_mod  name="Medeyna"  time="580"  cross="true"  storage="chara/1/МедейнаWorried.png"  ]
[chara_mod  name="Seyra"  time="600"  cross="true"  storage="chara/3/СейраAshamed.png"  ]
[tb_start_text mode=1 ]
#Сейра
...
[chara_mod  name="Medeyna"  time="600"  cross="true"  storage="chara/1/МедейнаЗадумчивость.png"  ]
[tb_start_text mode=1 ]
#
...
[tb_start_tyrano_code]
[glink target="q1" text="Как вы одолели Асмира?" graphic="button.png" x=80 y=560 font_color=0x000000 size=18 width=400 height=70 enterimg="button2.png"]
[glink target="q2" text="Ты уверена, что нас просто отпустят?" graphic="button.png" x=80 y=620 font_color=0x000000 size=18 width=400 height=70 enterimg="button2.png"]
...
[tb_start_tyrano_code]
[glink target="q11" text="Почему вы оставили Асмира в живых?" graphic="button.png" x=80 y=560 font_color=0x000000 size=16 width=400 height=70 enterimg="button2.png"]
[glink target="q22" text="Ты уйдёшь вместе с нами?" graphic="button.png" x=80 y=620 font_color=0x000000 size=18 width=400 height=70 enterimg="button2.png"]
...
[chara_mod  name="Medeyna"  time="600"  cross="true"  storage="chara/1/МедейнаSideEye.png"  ]
[tb_start_text mode=1 ]
...
[chara_mod  name="Seyra"  time="1500"  cross="true"  storage="chara/3/СейраФантом.png"  ]
[chara_mod  name="Medeyna"  time="600"  cross="true"  storage="chara/1/МедейнаИспуг.png"  ]
[tb_start_text mode=1 ]
#Медейна
Нет![p]
#
...
[chara_mod  name="Medeyna"  time="600"  cross="true"  storage="chara/1/МедейнаШокРасстройство.png"  ]
[tb_start_text mode=1 ]
И у неё не было причин выбирать правду.  Кроме, разве что, одной: спасти шкуру Асмира. [p]
[_tb_end_text]

[chara_mod  name="Medeyna"  time="600"  cross="true"  storage="chara/1/МедейнаНедовольна.png"  ]
[tb_start_text mode=1 ]
Стиснув зубы, она отчеканила заклинание. [p]
[_tb_end_text]

[chara_mod  name="Seyra"  time="600"  cross="true"  storage="chara/3/СейраФантом.png"  ]
[tb_start_text mode=1 ]

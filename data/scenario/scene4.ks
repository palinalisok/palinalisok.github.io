...
#
Нет, если запахнет жареным, она точно не станет рисковать головой ради незнакомых людей. Но если возможно избежать жертв, надо попытаться. [p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#
Она подумала о Гершви. Стал бы он судить её по людским меркам? [p]
Он казался очень человечным, но, Медейна думала, не стал бы корить её за циничные мысли. [p]
[_tb_end_text]
[endif  ]
[tb_start_text mode=1 ]

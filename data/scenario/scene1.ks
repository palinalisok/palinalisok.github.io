...
#
Она старалась лишний раз не бередить эту тему. Знала лишь, что родители Асмира погибли, когда он был еще ребенком, не оставив ему иного выбора, кроме как скитаться по миру в поисках своего места под солнцем. [p]
...
[tb_start_text mode=1 ]
Хотя для Медейны он уже стал большим, чем просто товарищем, и она не могла не искать скрытый смысл в его долгих, пронзительных взглядах и мягких, словно случайных прикосновениях.[p]
[_tb_end_text]
...
[tb_start_text mode=2 ]
#
Его шутка была вовсе не смешной из-за подвевшего его смущенного и напряженного голоса. И Медейна…[l][r]
[_tb_end_text]

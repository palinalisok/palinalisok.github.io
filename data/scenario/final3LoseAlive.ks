...
#
Чары вели её в нужном направлении, но ноги Медейна волочила ноги из чистого упрямства, то и дело оборачиваясь и проверяя, нет ли за ней погони. Возможно, стоило вернуться в деревню и перевести дух, но навязчивая мысль, что каждая потерянная минута может оказаться фатальной, подгоняла её. [p]
...
#
Он расстелил на земле свой изодранный плащ и пригласил её присесть. Высыпал сверху немногое содержимое собственной сумки.[p]
...
[tb_start_text mode=1 ]
#Асмир
{bold}У меня остался буквально глоток укрепляющего зелья. И вот еще ягод собрал, перекуси, если хочешь.{/bold}[p]
#
